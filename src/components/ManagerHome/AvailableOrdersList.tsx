...
interface AvailableOrdersListProps {
  ...
  onClaimOrder?: (id: string | number) => void;
  claimingOrderId?: string | number | null;
  testID?: string;
}

/**
 * AvailableOrdersList Component
 * 
 * Displays a list of pending orders (available to claim) for the Manager Home screen.
...
export const AvailableOrdersList: React.FC<AvailableOrdersListProps> = ({
  ...
  return (
    <View style={styles.container} testID={testID}>
      <SectionHeader title="Đơn mới chờ nhận" />
